...
<head>
    ...
    <title>Service Provider - History</title>
...
<body>
    ...
    <header id="head">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="servicehistory" class="active">Service History</a>
            <a href="#">My Ratings </a>
    ...
    <section id="maincs" class="row">
        ...
        <div class="container col-lg-8 sptable">
            <div class="row">
                <div class="col-lg-12">
                    <table class="table display nowrap" id="historysp" colspacing="0" style="width: 100%;">
                        <thead>
                            <tr id="firstrow">
                                <th>
                                    <div class="d-flex">
    ...
    <script src="<%= request.getContextPath() %>/resources/js/SP-History.js"></script>
