...
<head>
    ...
    <link href="<%= request.getContextPath() %>/resources/css/Warranty.css" type="text/css" rel="stylesheet">
    <link href="<%= request.getContextPath() %>/resources/css/Warranty-responsive.css" type="text/css" rel="stylesheet">
...
<body>
    <header id="head">
        <button id="topbtn" title="Back to Top" onclick="topFunction()">
            <div class="Ellipse-649">
                <img src="<%= request.getContextPath() %>/resources/img/img-Warranty/forma-1(1).png">
            </div>
        </button>
        <nav class="navbar navbar-expand-lg navbar-inverse bg-dark warrantynav">
            <div class="container-fluid custom-toggler">
                <a class="navbar-brand" href="homepage">
                    <img src="<%= request.getContextPath() %>/resources/img/img-Warranty/logo-small.png" class="white_logo_transparent_background">
                </a>
    ...
    <section id="bannerwarranty">
        <img src="<%= request.getContextPath() %>/resources/img/img-Warranty/guarantee-banner.png" class="gbanner img-responsive img-fluid">
    </section>
    ...
    <section id="guaranteepara">
        ...
        <div class="text-center d-flex align-items-center justify-content-center line1">
            <img src="<%= request.getContextPath() %>/resources/img/img-Warranty/forma-1-copy-5.png">
        </div>

        <div class="text-center">
            <p class="gmain">The professionals you'll get</p>
            <p class="gmainpara">All pros on the Helperland's platform are screened, background checked and rated by
                customers like you.
                And
                for cleaning, your favorite pro can come back again and again to clean your home just the way you like
                it.
            </p>
            <div class="damagepara">
                <span class="damage">
                    We covered your damage
                </span>
                <div class="text-center d-flex align-items-center justify-content-center line1">
                    <img src="<%= request.getContextPath() %>/resources/img/img-Warranty/forma-1-copy-5.png">
                </div>
                <span class="text-center damagerare">
                    In the rare event of damage, Helperland's got your back. Every booking on the Helperland platform is
                    insured.
                </span>
            </div>
        </div>
    ...
    <section id="backed">
        <div class="container d-flex justify-content-between guaflex">
            <div class="d-flex justify-content-center align-items-center guarimg">
                <img src="<%= request.getContextPath() %>/resources/img/img-Warranty/guarantee.png">
            </div>
            <div class="d-flex flex-column">
                <p class="guarbacked">Backed by the Helperland Service Guarantee</p>
                <p class="guarfinal">Your happiness is our goal. If you're not happy, we'll work to make it right. Helperland strives to
                    match you with the right pro for you and your home every time. If you are not satisfied with the
                    quality of the service, we'll send another pro at no extra charge for your next booking.</p>
            </div>
            <div class="d-flex align-items-center justify-content-center">
                <a type="button" class="bookguarantee text-decoration-none" href="BookNow.jsp">Book a Cleaner</a>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="logo col-md-1 col-sm-1">
                    <a href="homepage" class="text-decoration-none"><img
                            src="<%= request.getContextPath() %>/resources/img/img-Warranty/white-logo-transparent-background-copy-4.png" class="white-logo" alt="logo"></a>
                </div>
                ...
                <div class="icons col-md-1">
                    <a href="https://www.facebook.com/helperDE/" target="_blank" class="text-decoration-none "><img
                            src="<%= request.getContextPath() %>/resources/img/img-Warranty/facebook.png" srcset="<%= request.getContextPath() %>/resources/img/img-Warranty/facebook@2x.png 2x,
                            <%= request.getContextPath() %>/resources/img/img-Warranty/facebook@3x.png 3x" class="facebook"></a>
                    <a href="https://www.instagram.com/helperlandde/" target="_blank" class="text-decoration-none "><img
                            src="<%= request.getContextPath() %>/resources/img/img-Warranty/instagram.png" srcset="<%= request.getContextPath() %>/resources/img/img-Warranty/instagram@2x.png 2x,
                            <%= request.getContextPath() %>/resources/img/img-Warranty/instagram@3x.png 3x" class="instagram"></a>
                </div>
