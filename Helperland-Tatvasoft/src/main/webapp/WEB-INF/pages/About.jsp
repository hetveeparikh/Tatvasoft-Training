...
<head>
    ...
    <link href="<%= request.getContextPath() %>/resources/css/About.css" type="text/css" rel="stylesheet">
    <link href="<%= request.getContextPath() %>/resources/css/About-responsive.css" type="text/css" rel="stylesheet">
...
<body>
    ...
    <header id="head">
        <button id="topbtn" title="Back to Top" onclick="topFunction()">
            <div class="Ellipse-649">
                <img src="<%= request.getContextPath() %>/resources/img/img-About/forma-1(1).png">
            </div>
        </button>
        <nav class="navbar navbar-expand-lg navbar-inverse bg-dark aboutnav">
            <div class="container-fluid custom-toggler">
                <a class="navbar-brand" href="homepage">
                    <img src="<%= request.getContextPath() %>/resources/img/img-About/logo-small.png" class="white_logo_transparent_background">
                </a>
    ...
    <section id="contact-body">
        <img src="<%= request.getContextPath() %>/resources/img/img-About/hero-banner-img.png" class="about-us-banner img-fluid img-responsive">
        <span class="A-Few-words-about-us">
            A Few words about us
        </span>

        <div class="text-center d-flex align-items-center justify-content-center line1">
            <img src="<%= request.getContextPath() %>/resources/img/img-About/forma-1-copy-5.png">
        </div>
        <div class="text-center">
            <p class="aboutpara">
                ...
                We have a number of experienced cleaners to help you make cleaning out or shifting your home an easy
                affair.
            </p>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="logo col-md-1 col-sm-1">
                    <a href="homepage" class="text-decoration-none"><img
                            src="<%= request.getContextPath() %>/resources/img/img-About/white-logo-transparent-background-copy-4.png" class="white-logo" alt="logo"></a>
                </div>
                ...
                <div class="icons col-md-1">
                    <a href="https://www.facebook.com/helperDE/" target="_blank" class="text-decoration-none "><img
                            src="<%= request.getContextPath() %>/resources/img/img-About/facebook.png" srcset="<%= request.getContextPath() %>/resources/img/img-About/facebook@2x.png 2x,
                            <%= request.getContextPath() %>/resources/img/img-About/facebook@3x.png 3x" class="facebook"></a>
                    <a href="https://www.instagram.com/helperlandde/" target="_blank" class="text-decoration-none "><img
                            src="<%= request.getContextPath() %>/resources/img/img-About/instagram.png" srcset="<%= request.getContextPath() %>/resources/img/img-About/instagram@2x.png 2x,
                            <%= request.getContextPath() %>/resources/img/img-About/instagram@3x.png 3x" class="instagram"></a>
                </div>
