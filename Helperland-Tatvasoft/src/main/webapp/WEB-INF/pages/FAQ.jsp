...
<head>
  ...
  <link rel="stylesheet" href="<%= request.getContextPath() %>/resources/css/FAQ-responsive.css" type="text/css">
  <title>FAQ</title>
...
<body>
  ...
  <header id="head">
    <button id="topbtn" title="Back to Top" onclick="topFunction()">
        <div class="Ellipse-649">
            <img src="<%= request.getContextPath() %>/resources/img/img-FAQ/forma-1(1).png">
        </div>
    </button>
    <nav class="navbar navbar-expand-lg navbar-inverse bg-dark faqnav">
        <div class="container-fluid custom-toggler">
            <a class="navbar-brand" href="homepage">
                <img src="<%= request.getContextPath() %>/resources/img/img-FAQ/logo-small.png" class="white_logo_transparent_background">
            </a>
        ...
        <div class="modal fade" id="loginnn" aria-hidden="true" aria-labelledby="log" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    ...
                    <div class="text-center">
                        <a class="text-decoration-none fpassmodal" data-bs-target="#passm1"
                            data-bs-toggle="modal" data-bs-dismiss="modal">Forgot Password?</a>
                    </div>
                    <div class=" text-center">
        ...
        <div class="modal fade" id="passm1" aria-hidden="true" aria-labelledby="pass" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    ...
                    <a class="text-decoration-none text-center loginnowmodal"
                        data-bs-target="#loginnn" data-bs-toggle="modal" data-bs-dismiss="modal">Login
                        Now</a>
                </div>
            </div>
        </div>

        <div class="modal fade" id="signupmodal1" aria-hidden="true" aria-labelledby="signup"
            tabindex="-1">
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content">
                    <div class="modal-header">
  ...
  <section id="bannerFAQ">
    <img src="<%= request.getContextPath() %>/resources/img/img-FAQ/group-16.png" srcset="<%= request.getContextPath() %>/resources/img/img-FAQ/group-16@2x.png 2x,
    <%= request.getContextPath() %>/resources/img/img-FAQ/group-16@3x.png 3x" class="Group-16 img-fluid img-responsive" >
  </section>
  ...
  <section id="titleFAQ">
    ...
    <div class="text-center d-flex align-items-center justify-content-center line1">
      <img src="<%= request.getContextPath() %>/resources/img/img-FAQ/forma-1-copy-5.png">
    </div>

    <p class="Whether-you-are-Customer-or-Service-provider-We-have-tried-our justify-content-center text-center">
  ...
  <section id="contentFAQ">
    <div class="d-flex justify-content-center">
      <ul class="nav nav-pills tabs" role="tablist">
        <li class="nav-item custrect">
          <a class="nav-link active forcust" data-bs-toggle="pill" href="#cust">FOR CUSTOMER</a>
        </li>
        <li class="nav-item sprect">
          <a class="nav-link forsp" data-bs-toggle="pill" href="#sp">FOR SERVICE PROVIDER</a>
        </li>
      </ul>
    </div>
    ...
    <div class="tab-content">
      <div id="cust" class="accordion container tab-pane active">
        ...
        <div class="accordion-item" id="ques3">
          ...
          <div class="answer">
            <p>
              ...
              time. If you need to skip a booking within the minimum commitment, we’ll credit the value of
              the
        ...
        <div class="accordion-item" id="ques4">
          ...
          <div class="answer">
            <p>
              We strongly recommend that you are home for the first clean of your booking to show your
              cleaner
              around. Some customers choose to give a spare key to their cleaner, but this decision is
              based
      ...
      <div id="sp" class="container tab-pane fade accordion">
        <div class="accordion-item" id="ques5">
          <a href="#ques5" class="accordion-link">
          ...
          <div class="answer">
            <p>
              The self-employed service providers working with Helperland set their own payouts, this
              means that they decide how much they earn per hour.
            </p>
          </div>
        </div>

        <div class="accordion-item" id="ques6">
          <a href="#ques6" class="accordion-link">
          ...
          <div class="answer">
            <p>
              ...
              regards to their bookings during office hours. Before a service provider starts receiving
              jobs, every individual partner receives an orientation session to familiarise with the
              online platform and their profile.
            </p>
          </div>
        </div>
    ...
    <div class="Rectangle-12">
      <div class="row justify-content-between align-items-center">
        <div class="logo col-md-1 col-sm-1">
          <a href="homepage" class="text-decoration-none"><img src="<%= request.getContextPath() %>/resources/img/img-FAQ/white-logo-transparent-background-copy-4.png"
        ...
        <div class="icons col-md-1">
          <a href="https://www.facebook.com/helperDE/" target="_blank" class="text-decoration-none "><img
              src="<%= request.getContextPath() %>/resources/img/img-FAQ/facebook.png" srcset="<%= request.getContextPath() %>/resources/img/img-FAQ/facebook@2x.png 2x,
              <%= request.getContextPath() %>/resources/img/img-FAQ/facebook@3x.png 3x" class="facebook"></a>
          <a href="https://www.instagram.com/helperlandde/" target="_blank" class="text-decoration-none "><img
              src="<%= request.getContextPath() %>/resources/img/img-FAQ/instagram.png" srcset="<%= request.getContextPath() %>/resources/img/img-FAQ/instagram@2x.png 2x,
              <%= request.getContextPath() %>/resources/img/img-FAQ/instagram@3x.png 3x" class="instagram"></a>
        </div>
        <div class="Rectangle-12-copy-2"></div>

        <span class="-Helperland-All-rights-reserved-Terms-and-Conditions">
          ©2022 Helperland<span class="text-style-1">.</span> All rights reserved.&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"
            class="terms text-decoration-none"> Terms and
