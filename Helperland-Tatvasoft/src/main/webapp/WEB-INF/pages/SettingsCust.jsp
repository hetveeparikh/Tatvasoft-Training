...
<head>
    ...
    <link href="<%= request.getContextPath() %>/resources/css/SettingsCust.css" rel="stylesheet">
    <link href="<%= request.getContextPath() %>/resources/css/SettingsCust-responsive.css" rel="stylesheet">
...
<body>
    ...
    <section id="mainsetc" class="row">
        ...
        <div class="d-flex flex-column col-lg-7 maincusts">
            ...
            <div class="d-flex justify-content-center">
                <ul class="nav nav-pills tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " data-bs-toggle="pill" href="#" id="settingsaddress">
                            My Addresses
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <script src="<%= request.getContextPath() %>/resources/js/SettingsCust.js"></script>
</body>
