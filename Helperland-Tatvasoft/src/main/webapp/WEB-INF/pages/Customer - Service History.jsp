...
<body>
    ...
    <section id="maincs" class="row">
        ...
        <div class="sidebar col-lg-3 offset-lg-2 ">
            <a href="customerDashboard">Dashboard</a>
            <a href="ServiceHistory-customer" class="active">Service History</a>
            <a href="#">Service Schedule</a>
            <a href="#">Favourite Pros</a>
            <a href="#">Invoices</a>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">15/03/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">10/03/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">28/02/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">11/02/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">31/01/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">19/01/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">05/01/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex">
                                                <img src="<%= request.getContextPath() %>/resources/img/img-CS/greycalendar.png" class="gcal">
                                                <span class="cs-date">01/01/2018</span>
                                            </div>
                                            <span class="cs-time">12:00 - 18:00</span>
                                        </div>
                                    </td>
    ...
    <script src="<%=request.getContextPath()%>/resources/js/Customer - Service History.js"></script>
</body>
