...
<head>
    ...
    <link href="<%= request.getContextPath() %>/resources/css/SettingsSP.css" rel="stylesheet">
    <link href="<%= request.getContextPath() %>/resources/css/SettingsSP-responsive.css" rel="stylesheet">
...
<body>
    <header id="head">
        <nav class="navbar navbar-expand-lg navbar-inverse bg-dark settingsnav">
    ...
    <section id="mainsetsp" class="row">
        ...
        <div class="d-flex flex-column col-lg-7 mainsps">

            <div class="d-flex justify-content-center">
                <ul class="nav nav-pills tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active " data-bs-toggle="pill" href="#" id="settingsdetails">
                            My Details
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " data-bs-toggle="pill" href="#" id="settingspassword">
                            Change Password
                        </a>
                    </li>
                </ul>
    ...
    <script src="<%= request.getContextPath() %>/resources/js/SettingsSP.js"></script>
</body>
