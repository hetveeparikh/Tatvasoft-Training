...
<body>
    ...
    <header id="head">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="upcomingservice" class="active">Upcoming Services</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table class="table display nowrap" id="upcoming" colspacing="0" style="width: 100%;">
                        ...
                        <tbody>
                            <tr>
                                <td height="5" class="sid">323436</td>
                                <td height="5">
                                ...
                                <td class="dist">15 km</td>
                                <td>
                                    <form>
                                        <button type="submit" class="cancel text-white">Cancel</button>
                                    </form>
                                </td>
                            </tr>

                            <tr>
                                <td height="5" class="sid">323437</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323445</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323446</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323438</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323439</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323440</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323441</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323442</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323443</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
                            ...
                            <tr>
                                <td height="5" class="sid">323444</td>
                                <td height="5">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex">
                                            <img src="<%= request.getContextPath() %>/resources/img/img-US/calendar.png" class="calendar">
